...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			...
			"assets/images/DesktopWallpaper/DesktopWallpaler1.jpg",
			"assets/images/DesktopWallpaper/DesktopWallpaler2.jpg",
			"assets/images/DesktopWallpaper/DesktopWallpaler3.jpg",
			"assets/images/DesktopWallpaper/DesktopWallpaler4.jpg",
			"assets/images/DesktopWallpaper/DesktopWallpaler5.jpg"
		],
		// 移动背景图片（支持单张或多张随机）
